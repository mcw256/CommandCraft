...
namespace Grabcraft_Helper.UI_Stuff.ValueConverters
{
    public class StringToIconKindConverter : IValueConverter
    {
        public static StringToIconKindConverter Instance = new StringToIconKindConverter();

        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            Enum.TryParse<MaterialDesignThemes.Wpf.PackIconKind>(parameter as string, out MaterialDesignThemes.Wpf.PackIconKind ReturnedEnum);
            return ReturnedEnum;
